...
export const metadata: Metadata = {
  title: 'Youi Insurance Claims | Approved Restoration Provider | Claims Assistance',
  description: 'Preferred Youi insurance restoration provider. Full claims documentation, flexible payment options, and 24/7 claims assistance.',
  alternates: { canonical: 'https://disasterrecovery.com.au/insurance/youi' },
};
