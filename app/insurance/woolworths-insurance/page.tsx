...
export const metadata: Metadata = {
  ...
  description: 'Preferred Woolworths Insurance insurance restoration provider. Direct billing, no upfront costs, claim assistance. Call Online Form Available 24/7.' };
    ...
    <div className="min-h-screen">
      <section className="bg-gradient-to-r from-green-800 to-blue-800 text-white py-20">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl font-bold mb-4">Woolworths Insurance Insurance Claims</h1>
