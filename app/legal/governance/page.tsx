...
const documents = [
  ...
  },
  {
    ...
    "href": "/legal/forms/director-officer",
    icon: FaUserTie
  },
  {
    "title": "Employment Contracts",
    "href": "/legal/forms/employment-contracts",
    icon: FaBriefcase
  },
  {
    "title": "Consultant & Contractor",
    "href": "/legal/forms/consultant-contractor",
    icon: FaUserCog
  },
  {
    "title": "Conflict of Interest",
    "href": "/legal/forms/conflict-interest",
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-700">
            Corporate governance, employment, and advisory agreements
          </p>
        </div>
