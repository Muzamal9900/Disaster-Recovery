...
import { FaDatabase, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function DataUsageSharingAgreementsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-200">
          Data usage, sharing, and protection terms
        </p>
      </div>

      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-50 p-4 rounded-lg">
          <FaDatabase className="text-3xl text-blue-600 mb-2" />
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for data usage, sharing, and protection terms.
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of data collection, including detailed
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of usage rights, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Sharing Permissions</h3>
          <p className="mb-4">
            This section covers all aspects of sharing permissions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Privacy Compliance</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of data retention, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Deletion Rights</h3>
          <p className="mb-4">
            This section covers all aspects of deletion rights, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
