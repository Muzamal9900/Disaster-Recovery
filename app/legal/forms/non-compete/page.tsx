...
import { FaBan, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-200">
          Competition restrictions and non-compete terms
        </p>
      </div>

      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-50 p-4 rounded-lg">
          <FaBan className="text-3xl text-blue-600 mb-2" />
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for competition restrictions and non-compete terms.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Non-Compete Scope</h3>
          <p className="mb-4">
            This section covers all aspects of non-compete scope, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Geographic Restrictions</h3>
          <p className="mb-4">
            This section covers all aspects of geographic restrictions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Time Limitations</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Exceptions</h3>
          <p className="mb-4">
            This section covers all aspects of exceptions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Enforcement</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Remedies</h3>
          <p className="mb-4">
            This section covers all aspects of remedies, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
