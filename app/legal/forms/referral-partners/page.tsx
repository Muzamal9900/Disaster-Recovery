...
import { FaUserFriends, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function ReferralPartnerContractsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Referral Partner Contracts
        </h1>
        <p className="text-lg text-gray-200">
          Referral partnership terms and commissions
        </p>
      </div>

      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-50 p-4 rounded-lg">
          <FaUserFriends className="text-3xl text-blue-600 mb-2" />
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for referral partnership terms and commissions.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Referral Terms</h3>
          <p className="mb-4">
            This section covers all aspects of referral terms, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Qualification Criteria</h3>
          <p className="mb-4">
            This section covers all aspects of qualification criteria, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Tracking Methods</h3>
          <p className="mb-4">
            This section covers all aspects of tracking methods, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Exclusions</h3>
          <p className="mb-4">
            This section covers all aspects of exclusions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Term Duration</h3>
          <p className="mb-4">
            This section covers all aspects of term duration, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
