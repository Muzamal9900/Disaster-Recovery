...
import { FaPlug, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for api access and usage guidelines.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. API Access</h3>
          <p className="mb-4">
            This section covers all aspects of api access, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Usage Limits</h3>
          <p className="mb-4">
            This section covers all aspects of usage limits, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of authentication, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Data Rights</h3>
          <p className="mb-4">
            This section covers all aspects of data rights, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Service Levels</h3>
          <p className="mb-4">
            This section covers all aspects of service levels, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Restrictions</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Support Terms</h3>
          <p className="mb-4">
            This section covers all aspects of support terms, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
