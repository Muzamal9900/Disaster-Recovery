...
import { FaBullhorn, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function LeadGenerationAgreementsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-50 p-4 rounded-lg">
          <FaBullhorn className="text-3xl text-blue-600 mb-2" />
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for lead generation and qualification terms.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Lead Definitions</h3>
          <p className="mb-4">
            This section covers all aspects of lead definitions, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Quality Standards</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Delivery Methods</h3>
          <p className="mb-4">
            This section covers all aspects of delivery methods, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Pricing Structure</h3>
          <p className="mb-4">
            This section covers all aspects of pricing structure, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Exclusivity Terms</h3>
          <p className="mb-4">
            This section covers all aspects of exclusivity terms, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Performance Metrics</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Refund Policies</h3>
          <p className="mb-4">
            This section covers all aspects of refund policies, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
