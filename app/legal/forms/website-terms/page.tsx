...
import { FaGlobe, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function WebsiteTermsConditionsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for website usage terms and conditions.
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of acceptance of terms, including detailed
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of website use, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Content Rights</h3>
          <p className="mb-4">
            This section covers all aspects of content rights, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. User Submissions</h3>
          <p className="mb-4">
            This section covers all aspects of user submissions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Third Party Links</h3>
          <p className="mb-4">
            This section covers all aspects of third party links, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Disclaimers</h3>
          <p className="mb-4">
            This section covers all aspects of disclaimers, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of governing law, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
