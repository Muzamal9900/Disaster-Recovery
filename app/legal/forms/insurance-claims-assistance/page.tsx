...
import { FaFileInvoice, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function InsuranceClaimsAssistanceAgreementPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Insurance Claims Assistance Agreement
        </h1>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for insurance claim support and coordination.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Claims Assistance Scope</h3>
          <p className="mb-4">
            This section covers all aspects of claims assistance scope, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Documentation Support</h3>
          <p className="mb-4">
            This section covers all aspects of documentation support, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Adjuster Coordination</h3>
          <p className="mb-4">
            This section covers all aspects of adjuster coordination, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Direct Billing</h3>
          <p className="mb-4">
            This section covers all aspects of direct billing, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Claim Advocacy</h3>
          <p className="mb-4">
            This section covers all aspects of claim advocacy, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Fee Structure</h3>
          <p className="mb-4">
            This section covers all aspects of fee structure, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Client Obligations</h3>
          <p className="mb-4">
            This section covers all aspects of client obligations, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
