...
import { FaTools, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function EquipmentSupplyPurchaseAgreementsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Equipment/Supply Purchase Agreements
        </h1>
        <p className="text-lg text-gray-200">
          Equipment and supply procurement terms
        </p>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for equipment and supply procurement terms.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Equipment Specifications</h3>
          <p className="mb-4">
            This section covers all aspects of equipment specifications, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Purchase Terms</h3>
          <p className="mb-4">
            This section covers all aspects of purchase terms, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Warranty Provisions</h3>
          <p className="mb-4">
            This section covers all aspects of warranty provisions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Maintenance Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of maintenance requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Supply Chain Terms</h3>
          <p className="mb-4">
            This section covers all aspects of supply chain terms, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Quality Standards</h3>
          <p className="mb-4">
            This section covers all aspects of quality standards, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Return Policies</h3>
          <p className="mb-4">
            This section covers all aspects of return policies, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
