...
import { FaDollarSign, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function FeeStructureCommissionAgreementsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Fee Structure & Commission Agreements
        </h1>
        <p className="text-lg text-gray-200">
          Comprehensive fee and commission framework
        </p>
      </div>

      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-50 p-4 rounded-lg">
          <FaDollarSign className="text-3xl text-blue-600 mb-2" />
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for comprehensive fee and commission framework.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Fee Schedule</h3>
          <p className="mb-4">
            This section covers all aspects of fee schedule, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Commission Structure</h3>
          <p className="mb-4">
            This section covers all aspects of commission structure, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of payment terms, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Bonus Provisions</h3>
          <p className="mb-4">
            This section covers all aspects of bonus provisions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Territory Adjustments</h3>
          <p className="mb-4">
            This section covers all aspects of territory adjustments, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Volume Discounts</h3>
          <p className="mb-4">
            This section covers all aspects of volume discounts, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Annual Adjustments</h3>
          <p className="mb-4">
            This section covers all aspects of annual adjustments, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
