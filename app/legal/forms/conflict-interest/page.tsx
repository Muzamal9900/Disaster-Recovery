...
import { FaExclamationCircle, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function ConflictofInterestPoliciesPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-200">
          Conflict identification and management procedures
        </p>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for conflict identification and management procedures.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Conflict Definitions</h3>
          <p className="mb-4">
            This section covers all aspects of conflict definitions, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Disclosure Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of disclosure requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Management Procedures</h3>
          <p className="mb-4">
            This section covers all aspects of management procedures, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of prohibited activities, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Recusal Procedures</h3>
          <p className="mb-4">
            This section covers all aspects of recusal procedures, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Monitoring and Enforcement</h3>
          <p className="mb-4">
            This section covers all aspects of monitoring and enforcement, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Penalties</h3>
          <p className="mb-4">
            This section covers all aspects of penalties, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
