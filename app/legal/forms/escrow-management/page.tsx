...
import { FaLock, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function EscrowAccountManagementAgreementPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-200">
          Escrow account setup and management terms
        </p>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for escrow account setup and management terms.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Escrow Setup</h3>
          <p className="mb-4">
            This section covers all aspects of escrow setup, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Deposit Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of deposit requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Release Conditions</h3>
          <p className="mb-4">
            This section covers all aspects of release conditions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Account Management</h3>
          <p className="mb-4">
            This section covers all aspects of account management, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Interest Allocation</h3>
          <p className="mb-4">
            This section covers all aspects of interest allocation, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Dispute Procedures</h3>
          <p className="mb-4">
