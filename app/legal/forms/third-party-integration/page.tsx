...
import { FaPuzzlePiece, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function ThirdPartyIntegrationAgreementsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-50 p-4 rounded-lg">
          <FaPuzzlePiece className="text-3xl text-blue-600 mb-2" />
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for third-party service integration terms.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Integration Scope</h3>
          <p className="mb-4">
            This section covers all aspects of integration scope, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Technical Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of technical requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Data Exchange</h3>
          <p className="mb-4">
            This section covers all aspects of data exchange, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Security Standards</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Support Responsibilities</h3>
          <p className="mb-4">
            This section covers all aspects of support responsibilities, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Liability Allocation</h3>
          <p className="mb-4">
            This section covers all aspects of liability allocation, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Termination Procedures</h3>
          <p className="mb-4">
            This section covers all aspects of termination procedures, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
