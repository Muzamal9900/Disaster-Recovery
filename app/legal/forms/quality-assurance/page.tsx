...
import { FaCertificate, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function QualityAssuranceComplianceContractPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Quality Assurance & Compliance Contract
        </h1>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for quality control and compliance framework.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Inspection Procedures</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Compliance Requirements</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Corrective Actions</h3>
          <p className="mb-4">
            This section covers all aspects of corrective actions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Documentation Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of documentation requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Audit Rights</h3>
          <p className="mb-4">
            This section covers all aspects of audit rights, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Continuous Improvement</h3>
          <p className="mb-4">
            This section covers all aspects of continuous improvement, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
