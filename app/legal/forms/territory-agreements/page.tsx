...
import { FaMapMarkedAlt, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function TerritoryExclusivityAgreementsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-200">
          Geographic territory and exclusivity rights
        </p>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for geographic territory and exclusivity rights.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Territory Definition</h3>
          <p className="mb-4">
            This section covers all aspects of territory definition, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Exclusivity Rights</h3>
          <p className="mb-4">
            This section covers all aspects of exclusivity rights, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Performance Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of performance requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Territory Expansion</h3>
          <p className="mb-4">
            This section covers all aspects of territory expansion, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Competition Restrictions</h3>
          <p className="mb-4">
            This section covers all aspects of competition restrictions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Marketing Obligations</h3>
          <p className="mb-4">
            This section covers all aspects of marketing obligations, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Territory Protection</h3>
          <p className="mb-4">
            This section covers all aspects of territory protection, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
