...
import { FaShieldAlt, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function PrivacyPolicyDataProtectionPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for comprehensive data protection and privacy framework.
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of information collection, including detailed
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of use of information, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of data sharing, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of data security, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. User Rights</h3>
          <p className="mb-4">
            This section covers all aspects of user rights, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Cookies Policy</h3>
          <p className="mb-4">
            This section covers all aspects of cookies policy, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. GDPR Compliance</h3>
          <p className="mb-4">
            This section covers all aspects of gdpr compliance, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
