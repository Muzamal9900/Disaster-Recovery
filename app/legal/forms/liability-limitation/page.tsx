...
import { FaExclamationTriangle, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function LiabilityLimitationAgreementsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-200">
          Liability caps and limitation terms
        </p>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for liability caps and limitation terms.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Limitation of Liability</h3>
          <p className="mb-4">
            This section covers all aspects of limitation of liability, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Exclusion of Damages</h3>
          <p className="mb-4">
            This section covers all aspects of exclusion of damages, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Indemnification Terms</h3>
          <p className="mb-4">
            This section covers all aspects of indemnification terms, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Insurance Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of insurance requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Force Majeure</h3>
          <p className="mb-4">
            This section covers all aspects of force majeure, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Risk Allocation</h3>
          <p className="mb-4">
            This section covers all aspects of risk allocation, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Warranty Limitations</h3>
          <p className="mb-4">
            This section covers all aspects of warranty limitations, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
