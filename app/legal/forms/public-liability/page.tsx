...
import { FaUmbrellaBeach, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function PublicLiabilityInsuranceRequirementsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-200">
          Public liability coverage specifications
        </p>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for public liability coverage specifications.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Coverage Amounts</h3>
          <p className="mb-4">
            This section covers all aspects of coverage amounts, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Policy Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of policy requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Claim Procedures</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Additional Insureds</h3>
          <p className="mb-4">
            This section covers all aspects of additional insureds, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Exclusions</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Certificate Requirements</h3>
          <p className="mb-4">
