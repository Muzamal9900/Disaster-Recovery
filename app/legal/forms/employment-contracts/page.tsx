...
import { FaBriefcase, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for employee terms and conditions.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Position Description</h3>
          <p className="mb-4">
            This section covers all aspects of position description, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Compensation and Benefits</h3>
          <p className="mb-4">
            This section covers all aspects of compensation and benefits, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Working Conditions</h3>
          <p className="mb-4">
            This section covers all aspects of working conditions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Leave Entitlements</h3>
          <p className="mb-4">
            This section covers all aspects of leave entitlements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Performance Standards</h3>
          <p className="mb-4">
            This section covers all aspects of performance standards, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Termination Provisions</h3>
          <p className="mb-4">
            This section covers all aspects of termination provisions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Post-Employment Restrictions</h3>
          <p className="mb-4">
            This section covers all aspects of post-employment restrictions, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
