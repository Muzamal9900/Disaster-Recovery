...
import { FaUmbrella, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function InsuranceRequirementsAgreementPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-50 p-4 rounded-lg">
          <FaUmbrella className="text-3xl text-blue-600 mb-2" />
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for mandatory insurance coverage specifications.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Required Coverage Types</h3>
          <p className="mb-4">
            This section covers all aspects of required coverage types, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Minimum Coverage Amounts</h3>
          <p className="mb-4">
            This section covers all aspects of minimum coverage amounts, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Additional Insured Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of additional insured requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Certificate Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of certificate requirements, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Claims Procedures</h3>
          <p className="mb-4">
            This section covers all aspects of claims procedures, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Premium Responsibilities</h3>
          <p className="mb-4">
            This section covers all aspects of premium responsibilities, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Coverage Verification</h3>
          <p className="mb-4">
            This section covers all aspects of coverage verification, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
