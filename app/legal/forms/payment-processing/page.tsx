...
import { FaCreditCard, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <div className="grid md:grid-cols-4 gap-6 mb-8">
        <div className="bg-blue-50 p-4 rounded-lg">
          <FaCreditCard className="text-3xl text-blue-600 mb-2" />
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for payment processing and transaction terms.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Accepted Payment Methods</h3>
          <p className="mb-4">
            This section covers all aspects of accepted payment methods, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Processing Fees</h3>
          <p className="mb-4">
            This section covers all aspects of processing fees, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Settlement Times</h3>
          <p className="mb-4">
            This section covers all aspects of settlement times, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Chargebacks</h3>
          <p className="mb-4">
            This section covers all aspects of chargebacks, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Security Standards</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. PCI Compliance</h3>
          <p className="mb-4">
            This section covers all aspects of pci compliance, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Transaction Limits</h3>
          <p className="mb-4">
            This section covers all aspects of transaction limits, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
