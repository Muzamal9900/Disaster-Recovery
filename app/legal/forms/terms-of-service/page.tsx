...
import { FaFileAlt, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-200">
          Platform terms and conditions for users
        </p>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for platform terms and conditions for users.
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of service description, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. User Obligations</h3>
          <p className="mb-4">
            This section covers all aspects of user obligations, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Prohibited Activities</h3>
          <p className="mb-4">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This section covers all aspects of intellectual property, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
