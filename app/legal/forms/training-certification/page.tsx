...
import { FaGraduationCap, FaFileContract, FaCheckCircle, FaInfoCircle } from 'react-icons/fa'

export default function TrainingCertificationRequirementsPage() {
    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            This document establishes the legal framework for mandatory training and certification standards.
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">1. Initial Training Requirements</h3>
          <p className="mb-4">
            This section covers all aspects of initial training requirements, including detailed
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">2. Certification Standards</h3>
          <p className="mb-4">
            This section covers all aspects of certification standards, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">3. Ongoing Education</h3>
          <p className="mb-4">
            This section covers all aspects of ongoing education, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">4. Skills Assessment</h3>
          <p className="mb-4">
            This section covers all aspects of skills assessment, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">5. Training Records</h3>
          <p className="mb-4">
            This section covers all aspects of training records, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">6. Certification Renewal</h3>
          <p className="mb-4">
            This section covers all aspects of certification renewal, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
        ...
        <section className="mb-8">
          <h3 className="text-xl font-semibold mb-3">7. Competency Verification</h3>
          <p className="mb-4">
            This section covers all aspects of competency verification, including detailed
            provisions, requirements, and procedures applicable under Australian law.
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Comprehensive coverage of all relevant aspects</li>
