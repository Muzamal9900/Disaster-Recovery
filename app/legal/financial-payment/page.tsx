...
import { FaDollarSign, FaCreditCard, FaUndo, FaClock, FaLock } from 'react-icons/fa'

const documents = [
  {
    "title": "Fee Structure & Commissions",
    "href": "/legal/forms/fee-structure",
    icon: FaDollarSign
  },
  {
    "title": "Payment Processing",
    "href": "/legal/forms/payment-processing",
    icon: FaCreditCard
  },
  {
    "title": "Refund & Chargeback",
    "href": "/legal/forms/refund-chargeback",
    icon: FaUndo
  },
  {
    "title": "Late Payment Procedures",
    "href": "/legal/forms/late-payment",
    icon: FaClock
  },
  {
    "title": "Escrow Management",
    "href": "/legal/forms/escrow-management",
    icon: FaLock
  }
]
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-700">
            Payment processing, fee structures, and financial agreements
          </p>
        </div>
