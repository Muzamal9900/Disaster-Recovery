...
import { FaBullhorn, FaUserFriends, FaCheckCircle, FaCopyright, FaBan } from 'react-icons/fa'

const documents = [
  {
    "title": "Lead Generation",
    "href": "/legal/forms/lead-generation",
    icon: FaBullhorn
  },
  {
    "title": "Referral Partners",
    "href": "/legal/forms/referral-partners",
    icon: FaUserFriends
  },
  {
    "title": "Marketing Compliance",
    "href": "/legal/forms/marketing-compliance",
    icon: FaCheckCircle
  },
  {
    "title": "IP License Agreements",
    "href": "/legal/forms/ip-license",
    icon: FaCopyright
  },
  {
    "title": "Non-Compete Agreements",
    "href": "/legal/forms/non-compete",
    icon: FaBan
  }
]

export default function AffiliateMarketingDocumentsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">
            Affiliate & Marketing Documents
          </h1>
          <p className="text-xl text-gray-200">
            Marketing partnerships, referrals, and promotional agreements
          </p>
        </div>
