                ...
                {loading ? (
                  <tr>
                    <td colSpan={7} className="px-6 py-12 text-center">
                      ...
                      <p className="mt-2 text-gray-300">Loading proof of work claims...</p>
                    </td>
                  </tr>
                ) : claims.length === 0 ? (
                  <tr>
                    <td colSpan={7} className="px-6 py-12 text-center">
                      <p className="text-gray-300">No proof of work claims found</p>
                    </td>
                  </tr>
                ) : claims.map((claim) => (
                  <tr key={claim.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <div className="text-sm text-gray-300">{claim.clientName}</div>
                    ...
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <div className="text-sm text-gray-300">{claim.contractor.email}</div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      ...
                      <div className="text-xs text-gray-300">{claim.propertyType}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm font-medium text-gray-900">
