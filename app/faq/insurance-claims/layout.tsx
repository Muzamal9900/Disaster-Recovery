...
export const metadata: Metadata = {
  ...
  description: 'Frequently asked questions about insurance claims for disaster damage. Learn about billing and payment, claim denials, excess payments, and documentation requirements.',
