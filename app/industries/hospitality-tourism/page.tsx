...
export default function HospitalityTourismPage() {
  const risks = ["Cyclone damage","Flooding","Fire damage","Guest area contamination"];
  const locations = ["Gold Coast","Cairns","Sydney","Melbourne","Perth"];
      ...
      <section className="py-20 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            ...
            and expert restoration services tailored to hospitality & tourism.
          </p>
