...
export default function MiningResourcesPage() {
  const risks = ["Equipment damage","Site flooding","Chemical spills","Structural damage"];
  const locations = ["Pilbara WA","Hunter Valley NSW","Bowen Basin QLD","Goldfields WA"];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Mining & Resources Disaster Recovery
            </h1>
            <p className="text-xl mb-8">
              Specialised disaster recovery for mining operations, processing plants, and resource facilities
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Mining & Resources Disaster Risks We Handle
          </h2>
            ...
            {risks.map((risk, index) => (
              <Card key={index} className="p-6">
                ...
                <p className="text-sm text-gray-200">
                  Specialised response protocols for mining & resources sector
                </p>
              </Card>
            ))}
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">
              Why Mining & Resources Trusts Us
            </h2>
      ...
      <section className="py-20 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Protect Your Mining & Resources Assets
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Don't let disasters disrupt your operations. Get priority emergency response 
            and expert restoration services tailored to mining & resources.
          </p>
