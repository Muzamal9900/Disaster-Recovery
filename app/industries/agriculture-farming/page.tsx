...
export default function AgricultureFarmingPage() {
  const risks = ["Flood damage","Bushfire","Storm damage","Drought-related issues"];
  const locations = ["Murray-Darling Basin","Wheatbelt WA","Darling Downs QLD"];
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Agriculture & Farming Disaster Recovery
            </h1>
            <p className="text-xl mb-8">
              Farm and agricultural facility disaster recovery including livestock areas and crop storage
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Agriculture & Farming Disaster Risks We Handle
          </h2>
            ...
            {risks.map((risk, index) => (
              <Card key={index} className="p-6">
                ...
                <p className="text-sm text-gray-200">
                  Specialised response protocols for agriculture & farming sector
                </p>
              </Card>
            ))}
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">
              Why Agriculture & Farming Trusts Us
            </h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Servicing Agriculture & Farming nationwide
          </h2>
      ...
      <section className="py-20 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Protect Your Agriculture & Farming Assets
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Don't let disasters disrupt your operations. Get priority emergency response 
            and expert restoration services tailored to agriculture & farming.
          </p>
