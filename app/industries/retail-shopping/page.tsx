  ...
  return (
    <AgContentPageTemplate
      hero={{
        ...
        subtitle: 'Rapid restoration for retail stores and shopping centres to minimize business interruption. 24/7 emergency response, insurance approved, minimal downtime guaranteed.',
      }}
