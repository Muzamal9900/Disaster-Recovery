...
export const metadata: Metadata = {
  ...
  description: 'How much does flood restoration cost in SunshineCoast? Average prices, insurance coverage, payment plans. Get free quote now.' };
    ...
    <div className="min-h-screen">
      <section className="bg-gradient-to-r from-green-800 to-teal-800 text-white py-20">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl font-bold mb-4">SunshineCoast Flood restoration Cost</h1>
