...
export const metadata: Metadata = {
  title: 'Perth water damage Cost | Pricing Guide 2024',
  description: 'How much does water damage cost in Perth? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
    canonical: 'https://disasterrecovery.com.au/cost/perth-water-damage',
  },
};
