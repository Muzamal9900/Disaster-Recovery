...
export const metadata: Metadata = {
  ...
  description: 'How much does storm damage cost in Canberra? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
