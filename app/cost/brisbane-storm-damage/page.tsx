...
export const metadata: Metadata = {
  title: 'Brisbane storm damage Cost | Pricing Guide 2024',
  description: 'How much does storm damage cost in Brisbane? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
    canonical: 'https://disasterrecovery.com.au/cost/brisbane-storm-damage',
  },
};
