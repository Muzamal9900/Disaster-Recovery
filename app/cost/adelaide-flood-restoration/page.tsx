...
export const metadata: Metadata = {
  title: 'Adelaide flood restoration Cost | Pricing Guide 2024',
  description: 'How much does flood restoration cost in Adelaide? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
