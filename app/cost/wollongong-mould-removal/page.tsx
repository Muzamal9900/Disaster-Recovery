...
export const metadata: Metadata = {
  title: 'Wollongong mould removal Cost | Pricing Guide 2024',
  description: 'How much does mould removal cost in Wollongong? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
    canonical: 'https://disasterrecovery.com.au/cost/wollongong-mould-removal',
  },
};
