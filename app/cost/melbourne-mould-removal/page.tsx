...
export const metadata: Metadata = {
  ...
  description: 'How much does mould removal cost in Melbourne? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
    canonical: 'https://disasterrecovery.com.au/cost/melbourne-mould-removal',
  },
};

export default function MelbournemouldremovalCostPage() {
  return (
    <AgContentPageTemplate
      hero={{
        gradient: 'linear-gradient(135deg, #0F2942 0%, #1A5C3A 60%, #0F2942 100%)',
        icon: <DollarSign className="h-12 w-12" />,
        title: 'Melbourne Mould removal Cost',
      ...
      breadcrumbs={[
        ...
        { label: 'Melbourne Mould removal Cost' },
      ]}
      relatedPages={getRelatedPages('cost-mould')}
      sections={getCostSections({ city: 'Melbourne', serviceType: 'mould-removal' })}
    />
  );
}
