...
export const metadata: Metadata = {
  ...
  description: 'How much does water damage cost in Adelaide? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
