...
export const metadata: Metadata = {
  title: 'Sydney flood restoration Cost | Pricing Guide 2024',
  description: 'How much does flood restoration cost in Sydney? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
