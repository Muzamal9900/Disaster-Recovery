...
export const metadata: Metadata = {
  title: 'Canberra fire damage Cost | Pricing Guide 2024',
  description: 'How much does fire damage cost in Canberra? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
