...
export const metadata: Metadata = {
  title: 'SunshineCoast water damage Cost | Pricing Guide 2024',
  description: 'How much does water damage cost in SunshineCoast? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
