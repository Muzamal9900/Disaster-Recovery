...
export const metadata: Metadata = {
  ...
  description: 'How much does flood restoration cost in Perth? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
