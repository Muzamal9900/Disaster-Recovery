...
export const metadata: Metadata = {
  title: 'Melbourne fire damage Cost | Pricing Guide 2024',
  description: 'How much does fire damage cost in Melbourne? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
