...
export const metadata: Metadata = {
  title: 'Newcastle water damage Cost | Pricing Guide 2024',
  description: 'How much does water damage cost in Newcastle? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
