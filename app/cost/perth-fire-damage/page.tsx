...
export const metadata: Metadata = {
  title: 'Perth fire damage Cost | Pricing Guide 2024',
  description: 'How much does fire damage cost in Perth? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
