...
export const metadata: Metadata = {
  title: 'Wollongong water damage Cost | Pricing Guide 2024',
  description: 'How much does water damage cost in Wollongong? Average prices, insurance coverage, payment plans. Use our cost estimator for an instant estimate.',
  alternates: {
