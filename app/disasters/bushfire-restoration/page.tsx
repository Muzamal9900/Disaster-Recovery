...
export default function BushfireSmokeDamagePage() {
  const regions = ["NSW","Victoria","South Australia","Tasmania","Western Australia"];
  const cities = ["Sydney","Melbourne","Adelaide","Hobart","Perth"];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8">
              Complete bushfire recovery including smoke damage, soot removal, and structural restoration
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div>
                <p className="text-4xl font-bold text-blue-700">Immediate</p>
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mt-6 text-sm">
            Average response time: <strong>Immediate</strong> | 
            Service areas: <strong>5 regions</strong>
          </p>
        </div>
      </section>
    </div>
