...
export default function AustralianCapitalTerritoryPage() {
  const cities = ["Belconnen","Tuggeranong","Gungahlin","Woden Valley","Weston Creek"];
  const disasters = ["Bushfires","Storms","Hail","Frost Damage"];
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8">
              24/7 Online Emergency Response Across All ACT Regions
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Australian Capital Territory Disaster Response Services
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl font-bold mb-6">
              Australian Capital Territory Climate & Disaster Risks
            </h2>
            <p className="text-xl text-gray-700 mb-8">
              Bushfire smoke and severe storm events
            </p>
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="p-6">
                ...
                <p className="text-sm text-gray-700">
                  Custom disaster preparedness for Australian Capital Territory conditions
                </p>
              </Card>
              <Card className="p-6">
                ...
                <p className="text-sm text-gray-700">
                  Teams stationed across ACT for immediate deployment
                </p>
              </Card>
              <Card className="p-6">
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Australian Capital Territory's Trusted Disaster Recovery Partner
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            When disaster strikes in Australian Capital Territory, we're here 24/7. 
            From Canberra to regional areas, no location is too remote.
          </p>
