...
export const metadata: Metadata = {
  title: 'Disaster Recovery Whyalla | Emergency Services South',
  description: '24/7 disaster recovery in Whyalla, South Australia. Water damage, fire restoration, mould removal. Lodge a claim online 24/7.' ,
  alternates: {
