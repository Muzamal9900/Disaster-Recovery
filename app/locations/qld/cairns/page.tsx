...
export const metadata: Metadata = {
  ...
  description: '24/7 disaster recovery in Cairns, Queensland. Water damage, fire restoration, mould removal. Lodge a claim online 24/7.' ,
  alternates: {
    canonical: 'https://disasterrecovery.com.au/locations/qld/cairns',
  },
};
