...
export const metadata: Metadata = {
  title: 'Disaster Recovery Bunbury | Emergency Services Western',
  description: '24/7 disaster recovery in Bunbury, Western Australia. Water damage, fire restoration, mould removal. Lodge a claim online 24/7.' ,
  alternates: {
