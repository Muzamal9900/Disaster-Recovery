...
export const metadata: Metadata = {
  ...
  description: '24/7 disaster recovery in Mandurah, Western Australia. Water damage, fire restoration, mould removal. Lodge a claim online 24/7.' ,
  alternates: {
...
export default function MandurahPage() {
  return (
    <AgContentPageTemplate
      ...
      sections={getLocationSections({ city: 'Mandurah', state: 'WA' })}
