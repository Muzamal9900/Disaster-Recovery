...
export const metadata: Metadata = {
  title: 'Disaster Recovery Bendigo | 24/7 Emergency VIC',
  description: '24/7 disaster recovery in Bendigo, Victoria. Water damage, fire restoration, mould removal. Lodge a claim online 24/7.' ,
  alternates: {
    canonical: 'https://disasterrecovery.com.au/locations/vic/bendigo',
  },
};
