...
export const metadata: Metadata = {
  ...
  description: '24/7 disaster recovery in Penrith, New South Wales. Water damage, fire restoration, mould removal. Lodge a claim online 24/7.' ,
  alternates: {
    canonical: 'https://disasterrecovery.com.au/locations/nsw/penrith',
  },
};
