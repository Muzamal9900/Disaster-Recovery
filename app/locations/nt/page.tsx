...
export default function NorthernTerritoryPage() {
  const cities = ["Palmerston","Alice Springs","Katherine","Tennant Creek","Nhulunbuy"];
  const disasters = ["Cyclones","Flooding","Bushfires","Extreme Heat"];
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8">
              24/7 Online Emergency Response Across All NT Regions
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Northern Territory Disaster Response Services
          </h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Serving All Northern Territory Regions
          </h2>
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
            <Card className="p-4 bg-blue-50 border-blue-200">
              <MapPin className="h-5 w-5 text-blue-600 inline mr-2" />
              <span className="font-bold">Darwin</span> (Capital)
            </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl font-bold mb-6">
              Northern Territory Climate & Disaster Risks
            </h2>
            <p className="text-xl text-gray-700 mb-8">
              Severe tropical cyclones and monsoon flooding
            </p>
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="p-6">
                ...
                <p className="text-sm text-gray-700">
                  Custom disaster preparedness for Northern Territory conditions
                </p>
              </Card>
              <Card className="p-6">
                ...
                <p className="text-sm text-gray-700">
                  Teams stationed across NT for immediate deployment
                </p>
              </Card>
              <Card className="p-6">
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Northern Territory's Trusted Disaster Recovery Partner
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            When disaster strikes in Northern Territory, we're here 24/7. 
            From Darwin to regional areas, no location is too remote.
          </p>
