...
export const metadata: Metadata = {
  title: 'Apply to Join | NRP Contractor Network Australia',
  description: 'Join Australia\'s leading restoration contractor network. Access insurance leads, professional development, and grow your restoration business with NRP.',
  alternates: {
