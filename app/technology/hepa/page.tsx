          ...
          <div className="max-w-4xl">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="text-center p-4 rounded-lg bg-white/10 backdrop-blur">
                ...
                <div className="text-sm text-gray-700">Filtration Rate</div>
              </div>
              <div className="text-center p-4 rounded-lg bg-white/10 backdrop-blur">
                <div className="text-3xl font-bold text-cyan-600">2000</div>
                <div className="text-sm text-gray-700">CFM Airflow</div>
              </div>
              <div className="text-center p-4 rounded-lg bg-white/10 backdrop-blur">
                <div className="text-3xl font-bold text-emerald-600">0.3μm</div>
                <div className="text-sm text-gray-700">Particle Size</div>
              </div>
              <div className="text-center p-4 rounded-lg bg-white/10 backdrop-blur">
                <div className="text-3xl font-bold text-purple-600">H13</div>
                <div className="text-sm text-gray-700">HEPA Grade</div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-4 gap-4">
              {[
                ...
                <Card key={filter.stage} className="p-6 text-center">
                  ...
                  <p className="text-sm text-gray-700 mb-3">{filter.target}</p>
