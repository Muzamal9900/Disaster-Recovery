...
export default function CommercialMouldRemediationPage() {
  ...
  const faqs = [
    {
      question: 'How quickly can you respond to commercial mould remediation emergencies?',
      answer: 'We offer 24/7 emergency response for commercial mould remediation with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimize damage and reduce restoration costs.'
    },
    {
      question: 'Is commercial mould remediation covered by insurance?',
      answer: 'Most insurance policies cover commercial mould remediation damage when it\'s sudden and accidental. We work directly with all major insurers and can help manage your claim from start to finish.'
    },
    {
      question: 'What is the cost of commercial mould remediation services?',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-800">
              Expert commercial mould remediation services across Queensland. Fast response, professional restoration, insurance approved.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Professional Commercial Mould Remediation Services</h2>
            <p className="text-lg text-gray-700 mb-8">
              When you need expert commercial mould remediation services, Disaster Recovery provides comprehensive solutions 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Commercial Mould Remediation FAQs</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Commercial Mould Remediation Services?</h2>
      ...
      <Dialog open={showQuoteDialog} onOpenChange={setShowQuoteDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Commercial Mould Remediation Services</DialogTitle>
            <DialogDescription>
