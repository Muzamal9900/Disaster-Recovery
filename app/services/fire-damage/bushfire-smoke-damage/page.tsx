...
export default function BushfireSmokeDamagePage() {
  ...
  const faqs = [
    {
      question: 'How quickly can you respond to bushfire smoke damage emergencies?',
      answer: 'We offer 24/7 emergency response for bushfire smoke damage with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimize damage and reduce restoration costs.'
    },
    {
      question: 'Is bushfire smoke damage covered by insurance?',
      answer: 'Most insurance policies cover bushfire smoke damage damage when it\'s sudden and accidental. We work directly with all major insurers and can help manage your claim from start to finish.'
    },
    {
      question: 'What is the cost of bushfire smoke damage services?',
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Professional Bushfire Smoke Damage Services</h2>
            <p className="text-lg text-gray-700 mb-8">
              When you need expert bushfire smoke damage services, Disaster Recovery provides comprehensive solutions 
      ...
      <Dialog open={showQuoteDialog} onOpenChange={setShowQuoteDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Bushfire Smoke Damage Services</DialogTitle>
            <DialogDescription>
