...
export default function SepticTankOverflowCleanupPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://disasterrecovery.com.au/services/sewage-cleanup/septic-overflow',
    image: '/images/septic-overflow.jpg',
    priceRange: '$$-$$$'
  };

  const faqs = [
    {
      question: 'How quickly can you respond to septic tank overflow cleanup emergencies?',
      answer: 'We offer 24/7 emergency response for septic tank overflow cleanup with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimize damage and reduce restoration costs.'
    },
    {
      question: 'Is septic tank overflow cleanup covered by insurance?',
      answer: 'Most insurance policies cover septic tank overflow cleanup damage when it\'s sudden and accidental. We work directly with all major insurers and can help manage your claim from start to finish.'
    },
    {
      question: 'What is the cost of septic tank overflow cleanup services?',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-800">
              Expert septic tank overflow cleanup services across Queensland. Fast response, professional restoration, insurance approved.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Septic Tank Overflow Cleanup FAQs</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Septic Tank Overflow Cleanup Services?</h2>
      ...
      <Dialog open={showQuoteDialog} onOpenChange={setShowQuoteDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Septic Tank Overflow Cleanup Services</DialogTitle>
            <DialogDescription>
