...
export default function BlackWaterContaminationPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://disasterrecovery.com.au/services/sewage-cleanup/black-water-cleanup',
    image: '/images/black-water-cleanup.jpg',
    priceRange: '$$-$$$'
  };

  const faqs = [
    {
      question: 'How quickly can you respond to black water contamination emergencies?',
      answer: 'We offer 24/7 emergency response for black water contamination with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimize damage and reduce restoration costs.'
    },
    {
      question: 'Is black water contamination covered by insurance?',
      answer: 'Most insurance policies cover black water contamination damage when it\'s sudden and accidental. We work directly with all major insurers and can help manage your claim from start to finish.'
    },
    {
      question: 'What is the cost of black water contamination services?',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">
              Expert black water contamination services across Queensland. Fast response, professional restoration, insurance approved.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Black Water Contamination FAQs</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Black Water Contamination Services?</h2>
      ...
      <Dialog open={showQuoteDialog} onOpenChange={setShowQuoteDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Black Water Contamination Services</DialogTitle>
            <DialogDescription>
