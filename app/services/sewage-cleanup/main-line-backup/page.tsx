...
export default function MainSewerLineBackupPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Most insurance policies cover main sewer line backup damage when it\'s sudden and accidental. We work directly with all major insurers and can help manage your claim from start to finish.'
    },
    {
      question: 'What is the cost of main sewer line backup services?',
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Professional Main Sewer Line Backup Services</h2>
            <p className="text-lg text-gray-200 mb-8">
              When you need expert main sewer line backup services, Disaster Recovery provides comprehensive solutions 
