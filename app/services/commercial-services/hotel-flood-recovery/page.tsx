...
export default function HotelFloodRestorationPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://disasterrecovery.com.au/services/commercial-services/hotel-flood-recovery',
    image: '/images/hotel-flood-recovery.jpg',
    priceRange: '$$-$$$'
  };

  const faqs = [
    {
      question: 'How quickly can you respond to hotel flood restoration emergencies?',
      answer: 'We offer 24/7 emergency response for hotel flood restoration with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimize damage and reduce restoration costs.'
    },
    {
      question: 'Is hotel flood restoration covered by insurance?',
      answer: 'Most insurance policies cover hotel flood restoration damage when it\'s sudden and accidental. We work directly with all major insurers and can help manage your claim from start to finish.'
    },
    {
      question: 'What is the cost of hotel flood restoration services?',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Hotel Flood Restoration FAQs</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Hotel Flood Restoration Services?</h2>
      ...
      <Dialog open={showQuoteDialog} onOpenChange={setShowQuoteDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Hotel Flood Restoration Services</DialogTitle>
            <DialogDescription>
