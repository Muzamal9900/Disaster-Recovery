...
export default function GymFitnessCenterFloodingPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://disasterrecovery.com.au/services/commercial-services/gym-flooding',
    image: '/images/gym-flooding.jpg',
    priceRange: '$$-$$$'
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-200 mb-8">
              When you need expert gym & fitness centre flooding services, Disaster Recovery provides comprehensive solutions 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Gym & Fitness Centre Flooding FAQs</h2>
