          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-700">Professional cleanup and decontamination of crime scenes with compassionate, discreet service.</p>
              </div>
              
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <div className="text-3xl mb-4">🩺</div>
                <h3 className="text-xl font-semibold mb-3">Trauma Scene Cleanup</h3>
                <p className="text-gray-700">Specialised cleanup of traumatic incidents including accidents, suicides, and unattended deaths.</p>
              </div>
              
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <div className="text-3xl mb-4">🩸</div>
                <h3 className="text-xl font-semibold mb-3">Bloodborne Pathogen Cleanup</h3>
                <p className="text-gray-700">Safe removal and disposal of blood and other potentially infectious materials (OPIM).</p>
              </div>
              
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <div className="text-3xl mb-4">🗂️</div>
                <h3 className="text-xl font-semibold mb-3">Infectious Waste Removal</h3>
                <p className="text-gray-700">Proper handling and disposal of medical waste, sharps, and contaminated materials.</p>
              </div>
              
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <div className="text-3xl mb-4">⚗️</div>
                <h3 className="text-xl font-semibold mb-3">Drug Lab Cleanup</h3>
                <p className="text-gray-700">Specialised remediation of illegal drug manufacturing sites and chemical contamination.</p>
              </div>
              
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <div className="text-3xl mb-4">🏠</div>
                <h3 className="text-xl font-semibold mb-3">Hoarding Cleanup</h3>
                <p className="text-gray-700">Compassionate cleanup of hoarding situations with biohazard considerations.</p>
              </div>
            </div>
