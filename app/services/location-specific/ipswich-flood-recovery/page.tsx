...
export default function IpswichFloodRecoveryPage() {
  ...
  const faqs = [
    {
      question: 'How quickly can you respond to ipswich flood recovery emergencies?',
      answer: 'We offer 24/7 emergency response for ipswich flood recovery with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimize damage and reduce restoration costs.'
    },
    {
      question: 'Is ipswich flood recovery covered by insurance?',
      answer: 'Most insurance policies cover ipswich flood recovery damage when it\'s sudden and accidental. We work directly with all major insurers and can help manage your claim from start to finish.'
    },
    {
      question: 'What is the cost of ipswich flood recovery services?',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-800">
              Expert ipswich flood recovery services across Queensland. Fast response, professional restoration, insurance approved.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Professional Ipswich Flood Recovery Services</h2>
            <p className="text-lg text-gray-700 mb-8">
              When you need expert ipswich flood recovery services, Disaster Recovery provides comprehensive solutions 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Ipswich Flood Recovery FAQs</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Ipswich Flood Recovery Services?</h2>
      ...
      <Dialog open={showQuoteDialog} onOpenChange={setShowQuoteDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Ipswich Flood Recovery Services</DialogTitle>
            <DialogDescription>
