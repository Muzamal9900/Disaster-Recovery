...
export default function SunshineCoastWaterDamagePage() {
  ...
  const businessInfo = {
    ...
    url: 'https://disasterrecovery.com.au/services/location-specific/sunshine-coast-water-damage',
    image: '/images/sunshine-coast-water-damage.jpg',
    priceRange: '$$-$$$'
  };

  const faqs = [
    {
      question: 'How quickly can you respond to sunshine coast water damage emergencies?',
      answer: 'We offer 24/7 emergency response for sunshine coast water damage with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimize damage and reduce restoration costs.'
    },
    {
      question: 'Is sunshine coast water damage covered by insurance?',
      answer: 'Most insurance policies cover sunshine coast water damage damage when it\'s sudden and accidental. We work directly with all major insurers and can help manage your claim from start to finish.'
    },
    {
      question: 'What is the cost of sunshine coast water damage services?',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Sunshine Coast Water Damage
            </h1>
            <p className="text-xl mb-8 text-blue-800">
              Expert sunshine coast water damage services across Queensland. Fast response, professional restoration, insurance approved.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Sunshine Coast Water Damage FAQs</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Sunshine Coast Water Damage Services?</h2>
      ...
      <Dialog open={showQuoteDialog} onOpenChange={setShowQuoteDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Sunshine Coast Water Damage Services</DialogTitle>
            <DialogDescription>
