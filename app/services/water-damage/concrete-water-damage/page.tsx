...
export default function ConcreteWaterDamageRestorationPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://disasterrecovery.com.au/services/water-damage/concrete-water-damage',
    image: '/images/concrete-water-damage.jpg',
    priceRange: '$$-$$$'
  };

  const faqs = [
    {
      question: 'How quickly can you respond to concrete water damage restoration emergencies?',
      answer: 'We offer 24/7 emergency response for concrete water damage restoration with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimize damage and reduce restoration costs.'
    },
    {
      question: 'Is concrete water damage restoration covered by insurance?',
      answer: 'Most insurance policies cover concrete water damage restoration damage when it\'s sudden and accidental. We work directly with all major insurers and can help manage your claim from start to finish.'
    },
    {
      question: 'What is the cost of concrete water damage restoration services?',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-blue-800">
              Expert concrete water damage restoration services across Queensland. Fast response, professional restoration, insurance approved.
            </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-10">Concrete Water Damage Restoration FAQs</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Need Concrete Water Damage Restoration Services?</h2>
      ...
      <Dialog open={showQuoteDialog} onOpenChange={setShowQuoteDialog}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>Concrete Water Damage Restoration Services</DialogTitle>
            <DialogDescription>
