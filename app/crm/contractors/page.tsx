        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <Link href="/crm" className="text-gray-700 hover:text-gray-700">
                ← Back to Dashboard
              </Link>
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          {isLoading ? (
            <div className="p-12 text-center">
              ...
              <p className="mt-4 text-gray-700">Loading contractors from database...</p>
            </div>
          ) : (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-8">
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-700">Total Contractors</p>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-700">Enterprise Tier</p>
                <p className="text-2xl font-semibold text-gray-900">
