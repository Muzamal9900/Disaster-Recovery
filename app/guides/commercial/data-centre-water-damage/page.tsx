...
export default function DataCentreWaterDamagePage() {
  const structuredData = {
    ...
    mainEntity: [{
      '@type': 'Question',
      name: 'data centre water damage recovery',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for data centre water damage recovery. Our IICRC certified technicians provide expert solutions with 24/7 emergency response nationwide.' } }] };
        ...
        <section className="relative py-20 px-4 bg-gradient-to-b from-blue-900 to-blue-800 text-white">
          <div className="container mx-auto max-w-4xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Data Centre Water Damage Recovery Services
            </h1>
            <p className="text-xl mb-8 text-blue-800">
              Expert solutions and answers for "data centre water damage recovery"
            </p>
          ...
          <div className="container mx-auto max-w-4xl">
            <Card className="p-8">
              <h2 className="text-2xl font-bold mb-6">
                Understanding Data Centre Water Damage Recovery Services
              </h2>
              
              <div className="prose max-w-none">
                <p className="text-lg mb-4">
                  When searching for "data centre water damage recovery", you need reliable, professional answers from certified experts. 
                ...
                <p className="mb-4">
                  For "data centre water damage recovery", you need a restoration company that combines technical expertise with rapid response. 
                  Our team offers:
                </p>
