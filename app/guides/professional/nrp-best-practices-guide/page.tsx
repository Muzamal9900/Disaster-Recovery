...
export default function NRPBestPracticesGuidePage() {
  return (
    <AgGuidePageTemplate
      ...
      title="NRP Best Practices Guide - Professional Standards for Disaster Recovery"
      subtitle="Comprehensive guide to National Restoration Professionals best practices, mandatory procedures, and professional standards for emergency response and disaster recovery contractors."
