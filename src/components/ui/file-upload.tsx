          ...
          >
            <div className="flex items-center justify-between">
              ...
              {files.length > 1 && (
                <button
                  onClick={clearAll}
                  className="text-xs text-gray-700 hover:text-red-600 transition-colours"
                >
                  Clear All
                </button>
              )}
              ...
              {files.map((file, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex-shrink-0 p-1 text-gray-700 hover:text-red-600 transition-colours rounded-full hover:bg-red-50"
                  >
                    <X className="h-4 w-4" />
                  </button>
                </motion.div>
