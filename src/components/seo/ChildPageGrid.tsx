...
export const HUB_CHILDREN: Record<string, ChildPage[]> = {
  ...
  'property-types': [
    ...
    { label: 'Government Facilities', href: '/property-types/government', description: 'Government building restoration' },
    { label: 'Government Infrastructure', href: '/property-types/government-facilities', description: 'Government infrastructure disaster recovery' },
    ...
    { label: 'Residential Houses', href: '/property-types/residential-homes', description: 'House restoration and recovery services' },
    ...
    { label: 'Strata Complexes', href: '/property-types/strata-properties', description: 'Strata complex disaster recovery' },
  ...
  compare: [
    ...
    { label: 'Professional vs DIY', href: '/compare/professional-vs-diy', description: 'Professional restoration vs DIY approaches' },
  ],
  'specialty-services': [
