          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-700">Overall performance score</p>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-700">Compliance score</p>
              </CardContent>
            </Card>
            ...
            <ProtectedComponent permission="company.billing.view">
              ...
              >
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-700">Net profit this month</p>
                </CardContent>
              </Card>
            </ProtectedComponent>
            ...
            >
              ...
              <CardContent>
                ...
                <p className="text-xs text-gray-700">Conversion rate</p>
              </CardContent>
            </Card>
          </div>
