...
export default function FeedbackCollection({ jobId, contractorId, jobDetails, onSubmit, onCancel }: FeedbackCollectionProps) {
  ...
  const getOverallSentiment = () => {
    ...
    return { text: 'Rate your experience', emoji: '⭐', colour: 'text-gray-700' };
  };
        ...
        {[1, 2, 3, 4, 5].map(rating => (
          <button
            ...
            className={`p-1 transition-colours ${
              rating <= value ? getRatingColor(value) : 'text-gray-700 hover:text-blue-500'
            }`}
          >
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-700 mt-2">Your feedback helps us improve our service</p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-700 mt-2">Review your feedback before submitting</p>
            </div>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-700 mt-2">Help us improve by sharing your experience</p>
          </div>
          {onCancel && (
            <button
              onClick={onCancel}
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            <div className="flex items-center">
              <Briefcase className="w-4 h-4 text-gray-700 mr-2" />
          ...
          {steps.map((step, index) => (
            <React.Fragment key={step.id}>
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs mt-2 text-center text-gray-700 hidden sm:block">
                  {step.title}
                </p>
              </div>
