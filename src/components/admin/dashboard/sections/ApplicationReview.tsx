          ...
          {selectedApplication && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-sm text-gray-700">Applicant</Label>
                ...
                <div>
                  <Label className="text-sm text-gray-700">Application Score</Label>
                  <p className="font-medium">{calculateApplicationScore(selectedApplication)}%</p>
                </div>
                <div>
                  <Label className="text-sm text-gray-700">Risk Assessment</Label>
