      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-700">≤50km radius</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-700">50-100km radius</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-700">&gt;100km radius</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-700">Specific areas</p>
          </CardContent>
        </Card>
      </div>
                  ...
                  <tr key={territory.id} className="border-b hover:bg-gray-50">
                    <td className="p-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-700">{territory.contractorName}</p>
                      </div>
                    </td>
                    <td className="p-4">
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
            <div className="p-3 border rounded-lg">
              ...
              <p className="text-xs text-gray-700">0 contractors</p>
            </div>
            <div className="p-3 border rounded-lg">
              <p className="font-medium text-sm">Far North QLD</p>
              <p className="text-xs text-gray-700">1 contractor</p>
            </div>
            <div className="p-3 border rounded-lg">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-700">Split territory by postcodes or natural boundaries</p>
                  </button>
                  <button
                    className="w-full text-left p-3 border rounded-lg hover:bg-gray-50"
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-700">Allow overlap with lead distribution rules</p>
                  </button>
                  <button
                    className="w-full text-left p-3 border rounded-lg hover:bg-gray-50"
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-700">Reduce coverage radius for one contractor</p>
                  </button>
                </div>
              </div>
            </div>
