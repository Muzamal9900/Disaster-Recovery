      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {Object.entries(ROLE_DEFINITIONS).map(([role, definition]) => (
          ...
          >
            ...
            <CardContent>
              <p className="text-xs text-gray-700 mb-3">{definition.description}</p>
                  ...
                  {Object.entries(ROLE_DEFINITIONS).map(([role, definition]) => (
                    <th key={role} className="text-center p-4 font-medium text-sm min-w-[120px]">
                      <div className="flex flex-col items-center">
                        <span className="text-xs text-gray-700">Level {definition.hierarchy}</span>
                  ...
                  .map(([role, definition], index) => (
                    <div key={role} className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-700 mt-1">{definition.description}</p>
