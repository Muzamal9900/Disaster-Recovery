      ...
      <div className="flex justify-between items-start mb-3">
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">{job.client.name}</p>
          </div>
        </div>
  ...
  const PhotoCapture = () => (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="aspect-square bg-gray-100 rounded-lg flex flex-col items-center justify-center border-2 border-dashed border-gray-300">
          <Camera className="w-8 h-8 text-gray-700 mb-2" />
          <span className="text-sm text-gray-700">During</span>
        </div>
        <div className="aspect-square bg-gray-100 rounded-lg flex flex-col items-center justify-center border-2 border-dashed border-gray-300">
          <Camera className="w-8 h-8 text-gray-700 mb-2" />
          ...
          <div key={doc} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-700">PDF • 245 KB</p>
              </div>
            </div>
            <button className="p-1.5 text-gray-700 hover:text-blue-600">
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      ...
      <div className="space-y-3 mb-4">
        <div className="p-3 bg-gray-50 rounded-lg">
          ...
          <p className="text-xs text-gray-700 mt-1">Added 2 hours ago</p>
        </div>
        
        <div className="p-3 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-700">Client requested priority attention to kitchen area for insurance purposes.</p>
          <p className="text-xs text-gray-700 mt-1">Added 1 hour ago</p>
        </div>
      </div>
    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-700 mt-2">Field technician job tracking and management</p>
        </div>
        ...
        <div>
          {selectedJob ? (
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-700">{selectedJob.client.name}</p>
                  </div>
                  <button
            ...
            <div className="bg-gray-50 rounded-lg p-8 text-center">
              ...
              <p className="text-gray-700">Select a job to view details</p>
            </div>
          )}
        </div>
      </div>
