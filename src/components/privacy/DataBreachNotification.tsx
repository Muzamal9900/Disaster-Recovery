              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-700">Records Affected</p>
                  </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-700">Users Notified</p>
                  </div>
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-700">Resolved</p>
                  </div>
                  ...
                  {activeBreaches.map(breach => (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-3 gap-4 text-sm">
                        <div>
                          <p className="text-gray-700">Affected Records</p>
                          <p className="font-medium">{breach.affectedRecords.toLocaleString()}</p>
                        </div>
                        <div>
                          <p className="text-gray-700">Investigation Status</p>
