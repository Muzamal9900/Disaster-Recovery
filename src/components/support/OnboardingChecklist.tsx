...
const categoryInfo = {
  ...
  setup: {
    ...
    icon: Settings,
    colour: 'text-gray-700 bg-gray-100'
  }
};
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700">Required Remaining</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-blue-600">
                {checklist.items.filter(i => !i.isCompleted && !i.isRequired).length}
              </p>
              <p className="text-sm text-gray-700">Optional</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-700">Est. Time Left</p>
            </div>
          </div>
        </CardContent>
      </Card>
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <p className={cn(
                                "font-medium",
                                item.isCompleted && "line-through text-gray-700"
                              )}>
                                {item.title}
                              </p>
                              {item.isRequired && (
