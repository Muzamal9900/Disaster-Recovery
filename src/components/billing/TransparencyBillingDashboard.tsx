        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">(AUD, incl GST)</p>
            </div>
          </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      ...
                      {categorySection.description && (
                        <p className="text-sm text-gray-700 mt-1">{categorySection.description}</p>
                      )}
                    </div>
                  </div>
                  {isExpanded ? (
                        ...
                        {categoryGuidelines.map((item) => (
                          <div key={item.id} className="border rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                <p className="text-sm text-gray-700">Normal Hours (8am-4pm Mon-Fri)</p>
                                <p className="text-lg font-semibold text-green-600">
                                  ${item.priceRange.normalHours?.min}–${item.priceRange.normalHours?.max}/hr
                                </p>
                              </div>
                              <div>
                                <p className="text-sm text-gray-700">After Hours</p>
                        ...
                        {categoryGuidelines.map((item) => (
                          <div key={item.id} className="border rounded-lg p-4">
                            ...
                            {item.priceRange.withRemoteMonitoring && item.priceRange.standard ? (
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  <p className="text-sm text-gray-700">With Remote Monitoring</p>
                                  <p className="text-lg font-semibold text-purple-600">
                                    ${item.priceRange.withRemoteMonitoring.min}–${item.priceRange.withRemoteMonitoring.max}/day
                                  </p>
                                </div>
                                <div>
                                  <p className="text-sm text-gray-700">Standard (max 4 days/week)</p>
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  <p className="text-sm text-gray-700">First Hour</p>
                                  <p className="text-lg font-semibold text-purple-600">
                                    ${item.priceRange.firstUnit.min}–${item.priceRange.firstUnit.max}
                                  </p>
                                </div>
                                <div>
                                  <p className="text-sm text-gray-700">Each Additional Hour</p>
                                  <p className="text-lg font-semibold text-blue-600">
