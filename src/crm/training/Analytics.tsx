        ...
        <TabsList className="grid grid-cols-3 gap-4">
          ...
          >
            <span className="flex items-center gap-2">
              {completedSections.includes('Performance Analytics') ? (
          ...
          >
            <span className="flex items-center gap-2">
              {completedSections.includes('Predictive Analytics') ? (
                <CheckCircle2 className="h-4 w-4 text-green-600" />
              ) : (
                <BookOpen className="h-4 w-4" />
              )}
          ...
          >
            <span className="flex items-center gap-2">
              {completedSections.includes('Competitive Intelligence') ? (
                <CheckCircle2 className="h-4 w-4 text-green-600" />
              ) : (
                <BookOpen className="h-4 w-4" />
              )}
...
• Market Analytics - Demand forecasting, seasonal patterns
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                <Button
                  variant="outline"
                  onClick={() => markSectionComplete('Performance Analytics')}
                  disabled={completedSections.includes('Performance Analytics')}
                >
                  {completedSections.includes('Performance Analytics') ? (
                    <>
...
• Risk assessment for large projects
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                <Button
                  variant="outline"
                  onClick={() => markSectionComplete('Predictive Analytics')}
                  disabled={completedSections.includes('Predictive Analytics')}
                >
                  {completedSections.includes('Predictive Analytics') ? (
                    <>
                      <CheckCircle2 className="h-4 w-4 mr-2" />
...
• Growth opportunity mapping
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                <Button
                  variant="outline"
                  onClick={() => markSectionComplete('Competitive Intelligence')}
                  disabled={completedSections.includes('Competitive Intelligence')}
                >
                  {completedSections.includes('Competitive Intelligence') ? (
                    <>
                      <CheckCircle2 className="h-4 w-4 mr-2" />
        ...
        <Card className="border-green-200 bg-gradient-to-r from-green-50 to-green-100">
          <CardHeader>
            ...
            <CardDescription className="text-green-700">
              Congratulations! You've successfully completed the Advanced Analytics module.
            </CardDescription>
          </CardHeader>
          <CardContent>
