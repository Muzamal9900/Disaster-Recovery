    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <Tabs defaultValue="section-0" className="space-y-4">
        <TabsList className="grid grid-cols-3 gap-4">
          ...
          >
            <span className="flex items-center gap-2">
              {completedSections.includes('Multi-Channel Communication') ? (
          ...
          >
            <span className="flex items-center gap-2">
              {completedSections.includes('Automated Notifications') ? (
                <CheckCircle2 className="h-4 w-4 text-green-600" />
              ) : (
                <BookOpen className="h-4 w-4" />
              )}
          ...
          >
            <span className="flex items-center gap-2">
              {completedSections.includes('Insurance Company Interface') ? (
                <CheckCircle2 className="h-4 w-4 text-green-600" />
              ) : (
                <BookOpen className="h-4 w-4" />
              )}
        ...
        <TabsContent value="section-0" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Multi-Channel Communication</CardTitle>
            </CardHeader>
...
• Emergency Response - 24/7 support access
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                <Button
                  variant="outline"
                  onClick={() => markSectionComplete('Multi-Channel Communication')}
                  disabled={completedSections.includes('Multi-Channel Communication')}
                >
                  {completedSections.includes('Multi-Channel Communication') ? (
                    <>
...
• Emergency escalation → Priority alert
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                <Button
                  variant="outline"
                  onClick={() => markSectionComplete('Automated Notifications')}
                  disabled={completedSections.includes('Automated Notifications')}
                >
                  {completedSections.includes('Automated Notifications') ? (
                    <>
                      <CheckCircle2 className="h-4 w-4 mr-2" />
        ...
        <TabsContent value="section-2" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Insurance Company Interface</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="prose prose-gray max-w-none">
                <div className="whitespace-pre-line text-gray-700 leading-relaxed">
...
• Invoice and payment processing
              ...
              <div className="flex items-center justify-between pt-4 border-t">
                <Button
                  variant="outline"
                  onClick={() => markSectionComplete('Insurance Company Interface')}
                  disabled={completedSections.includes('Insurance Company Interface')}
                >
                  {completedSections.includes('Insurance Company Interface') ? (
                    <>
                      <CheckCircle2 className="h-4 w-4 mr-2" />
        ...
        <Card className="border-green-200 bg-gradient-to-r from-green-50 to-green-100">
          <CardHeader>
            ...
            <CardDescription className="text-green-700">
              Congratulations! You've successfully completed the Communication Hub module.
            </CardDescription>
          </CardHeader>
          <CardContent>
