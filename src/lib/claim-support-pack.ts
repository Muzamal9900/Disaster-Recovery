...
export const INSURER_CONTACTS: InsurerContact[] = [
  { name: 'NRMA Insurance', phone: '1800 625 031', claimsUrl: 'nrma.com.au/insurance/claims' },
  { name: 'RACV', phone: '13 72 28', claimsUrl: 'racv.com.au/insurance/home-insurance/claims' },
  { name: 'AAMI', phone: '13 22 44', claimsUrl: 'aami.com.au/claims' },
  { name: 'Suncorp', phone: '13 11 55', claimsUrl: 'suncorp.com.au/insurance/claims' },
  { name: 'Allianz', phone: '13 10 00', claimsUrl: 'allianz.com.au/claims' },
  { name: 'QBE', phone: '133 723', claimsUrl: 'qbe.com/au/claims' },
  { name: 'Budget Direct', phone: '1300 555 182', claimsUrl: 'budgetdirect.com.au/claims' },
  { name: 'GIO', phone: '13 10 10', claimsUrl: 'gio.com.au/insurance/claims' },
  { name: 'Youi', phone: '13 96 84', claimsUrl: 'youi.com.au/claims' },
  { name: 'CommInsure', phone: '13 24 23', claimsUrl: 'comminsure.com.au/claims' },
  { name: 'ANZ Insurance', phone: '13 16 14', claimsUrl: 'anz.com.au/insurance/claims' },
...
export const STATE_CONSUMER_CONTACTS: StateConsumerContact[] = [
  ...
  { state: 'WA', name: 'WA Consumer Protection', phone: '1300 30 40 54', website: 'commerce.wa.gov.au/consumer-protection' },
...
export const VERIFIED_CONTACTS = {
  ...
  ils: {
    ...
    phone: '1300 663 464',
    hours: 'Mon–Fri 9:30am–4:30pm AEDT (Press 1 for natural disasters/weather events)',
  ...
  ndh: {
    ...
    phone: '1800 007 007',
    hours: 'Mon–Fri 9:30am–4:30pm AEDT. Live chat Mon–Fri 9am–8pm',
  ...
  ica: {
    ...
    website: 'https://www.insurancecouncil.com.au',
    phone: '1800 734 621',
