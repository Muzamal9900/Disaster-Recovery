...
const DEFAULT_QUESTIONS: Record<string, { q: string; a: string }[]> = {
  'biohazard-cleanup': [
    ...
    { q: 'Is biohazard cleanup covered by insurance?', a: 'Many home and commercial insurance policies cover biohazard cleanup when it results from a covered event (fire, storm, vandalism). Trauma scene cleaning may be covered under specific policy provisions. We check your policy and direct-bill your insurer for covered work.' },
  ...
  'carpet-drying': [
    ...
    { q: 'Does insurance cover carpet drying?', a: 'Yes, most home insurance policies cover carpet drying and restoration as part of a water damage claim from a sudden event. We direct-bill your insurer so there are no upfront costs for covered events.' },
...
function getDefaultQuestions(topic: string): { q: string; a: string }[] {
  ...
  return [
    ...
    { q: `How much does ${topic.replace(/-/g, ' ')} cost?`, a: `Costs vary based on the extent of damage, property size, materials involved, and specific requirements. For insured events, we direct-bill your insurer and you pay only your policy excess. We provide free, no-obligation assessments and written quotes before any chargeable work begins.` },
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <ul>
            <li><strong>Insurance direct billing</strong> — As approved providers for all major Australian insurers, we bill your insurer directly. You pay only your policy excess.</li>
