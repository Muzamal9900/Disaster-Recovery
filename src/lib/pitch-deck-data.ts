export const pitchDeckData = {
  slides: [
    ...
    },
    {
      ...
      animation: 'matrix',
      duration: 10000,
      narration: 'Our technology platform leverages artificial intelligence for intelligent matching, automated triage, predictive forecasting, and real-time analytics. We\'re not just digitising the industry - we\'re revolutionising how disaster recovery operates.',
